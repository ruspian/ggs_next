...
const Toaster = forwardRef(({ defaultPosition = "bottom-right" }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    show({
      ...
      // Pastikan variant valid. Kalau ngaco, paksa jadi 'default'
      const safeVariant = variantIcons[variant] ? variant : "default";

      // Pastikan Icon ada isinya. Fallback ke Info.
      const Icon = variantIcons[safeVariant] || Info;
        ...
        (toastId) => (
          ...
          >
            <div className="flex items-start gap-2">
              <Icon
                className={cn("h-4 w-4 mt-0.5 shrink-0", iconColor[variant])}
              />
            ...
            <div className="flex items-center gap-2">
              {actions?.label &&
                // Cek apakah komponen Button ke-import dgn benar?
                // Kalau Button undefined, render button HTML biasa biar gak crash
                Button && (
                  <Button
