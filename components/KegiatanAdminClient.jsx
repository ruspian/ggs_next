...
const KegiatanAdminClient = ({ posts }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <h3 className="text-xl font-bold text-slate-900 mt-1">48</h3>
        </div>
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
          <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">
            Total Views
          </p>
          <h3 className="text-xl font-bold text-emerald-600 mt-1">12.5k</h3>
        </div>
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
          <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">
            Published
          </p>
          <h3 className="text-xl font-bold text-blue-600 mt-1">45</h3>
        </div>
        <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
          <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">
            Draft
          </p>
          <h3 className="text-xl font-bold text-amber-600 mt-1">3</h3>
        </div>
      </div>
